  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative aspect-[3/4] overflow-hidden bg-[#E8E5DF]/50 max-w-md mx-auto lg:max-w-none">
            <img
              src={profile.portraitImage}
              alt={`Portrait of ${profile.name} holding camera in natural daylight`}
              loading="lazy"
              referrerPolicy="no-referrer"
              className="w-full h-full object-cover object-center filter contrast-[1.02] grayscale-[15%]"
            />
            <div className="absolute bottom-4 left-4 text-[10px] tracking-[0.25em] uppercase text-[#FAF8F5]/90 bg-black/30 backdrop-blur-sm px-2.5 py-1">
              {profile.name} &mdash; {profile.vendorName}
            </div>
          </div>
        </motion.div>
          ...
          <div className="pt-6 border-t border-[#E8E5DF] grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs tracking-wider">
            <div>
              ...
              <p className="text-[#141414] font-medium leading-relaxed">
                Quiet observation, natural daylight, unhurried candids, and heartfelt intimacy.
              </p>
            </div>
            <div>
              <span className="text-[#787672] uppercase text-[10px] tracking-[0.25em] block mb-1">
